...
DROP TABLE CASCADE ARTICLES;
DROP TABLE CASCADE COMMENTS;
DROP TABLE CASCADE VIEWS;
DROP TABLE CASCADE LIKES;
DROP TABLE CASCADE TAGS;
DROP TABLE CASCADE TAGGINGS;
DROP TABLE CASCADE FOLLOWS;
DROP TABLE CASCADE BOOKMARKS;
