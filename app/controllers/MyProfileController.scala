//package controllers
//
//import models.{AuthorFollowers, User}
//
...
//import repositories.{MyProfileRepository, UserRepository}
...
//
//
//  def getFollowersStats() = SecuredAction {
//    implicit request => {
//      val listJson = MyProfileRepository.getStatsFollowers(request.identity.id.get).
//        map(AuthorFollowers.authorFollowersWriter.writes)
//      Ok(Json.obj("message" -> listJson))
//    }
//  }
//}
//
